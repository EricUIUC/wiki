...
[ECE110](ECE110.md), [PHYS212](../PHYS%20Course%20Offerings/PHYS212.md), and credit or concurrent registration in [MATH285](../MATH%20Course%20Offerings/MATH285.md) are listed as official prerequisites of this course. While it is recommended to take MATH 285 beforehand, the course curriculum introduces important applications of differential equation around the 4th week of ECE 210. As such, those who take MATH 285 concurrently with ECE 210 will not be behind by much compared to those who take it concurrently.  Note that there are slight differences in methods used for many overlapping topics between MATH285 and ECE210 which make these courses somewhat challenging to take concurrently. For example, ECE210 teaches Fourier transforms in terms of strictly complex numbers, while MATH285 reduces these expressions to real sine and cosine functions.
