...
- Low level languages: Covered near the end of the course, and helps the student understand how to link high level languages like C++ and Java with computers together. Currently, the ECE 120 curriculum uses LC3 as the low level language example, and understanding how each line of code is processed by the LC3 hardware will help you not only in ECE 120, but also in ECE 220
